  ...
  return (
    <div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-2 bg-fluent-100 dark:bg-fluent-800/40 p-5 rounded-md text-base border border-fluent-200 dark:border-fluent-700/50">
          <p>
          ...
          <p className="mt-3 text-lg">Current filler word count: <span className="font-bold">{fillerWordCount}</span></p>
        </div>
      </div>
    </div>
  );
